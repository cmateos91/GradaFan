-- ==========================================
-- 🏟️ GradaFan - Database Schema
-- ==========================================
-- Red social de fútbol para LaLiga
-- Base de datos PostgreSQL en Supabase
--
-- INSTRUCCIONES:
-- 1. Abre tu proyecto GradaFan en Supabase
-- 2. Ve a SQL Editor
...
-- ==========================================
-- 4️⃣ TABLA: chat_messages (Chat en Vivo)
-- ==========================================
...
-- ==========================================
-- 9️⃣ DATOS DE EJEMPLO (Opcional)
-- ==========================================

-- Insertar debate de ejemplo (solo si no hay debates)
-- NOTA: Esto fallará hasta que tengas un usuario registrado
-- Lo puedes ejecutar después de registrarte

-- INSERT INTO public.debates (title, description, author_id, likes, featured)
-- SELECT
--     '¿Cuál es tu opinión sobre la temporada actual de LaLiga?',
--     'Este es un debate de ejemplo. Comparte tu opinión sobre cómo va la temporada.',
--     id,
--     5,
--     true
...
-- Próximos pasos:
-- 1. Registrar un usuario de prueba desde tu app
-- 2. Verificar que se cree el profile automáticamente
-- 3. Crear debates y comentarios desde la app
-- ==========================================
