class DebateFeed {
    ...
    getDebates() {
        ...
        if (this.options.featuredOnly) {
            debates = window.DebatesData.getFeatured();
        } else if (this.options.category) {
            debates = window.DebatesData.getByCategory(this.options.category);
        } else {
            debates = window.DebatesData.getAll();
        }

        if (this.options.limit) {
            debates = debates.slice(0, this.options.limit);
        }
