...
const ICONS = {
    ...
    crown: `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            <path d="M4.5 18.75h15a.75.75 0 0 0 .75-.75v-2.438l-3.615-6.573a.75.75 0 0 0-1.232-.11l-2.84 3.313a.75.75 0 0 1-1.126 0L8.597 8.88a.75.75 0 0 0-1.232.11L3.75 15.562V18a.75.75 0 0 0 .75.75Zm0 0V19.5a1.5 1.5 0 0 0 1.5 1.5h12a1.5 1.5 0 0 0 1.5-1.5v-.75h-15Z"/>
        </svg>
    `,
...
// Función wrapper para inicialización única
function initIconsOnce() {
    if (iconsInitialized) {
        return;
    }
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initIconsOnce);
} else {
    initIconsOnce();
}
